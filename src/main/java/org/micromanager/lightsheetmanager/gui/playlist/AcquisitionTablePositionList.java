...
public class AcquisitionTablePositionList extends JScrollPane {
    ...
    public static final String NO_POSITION_LIST = AcquisitionMetadata.NO_POSITION_LIST; //"None";

    private String selectedName_;
    private String prevSelectedName_;

    private final JList<String> list_;
    private final DefaultListModel<String> model_;
