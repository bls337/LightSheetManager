...
/**
 * GaussianCurveFitter with offset (was GaussianWithOffsetCurveFitter)
 */
public class GaussianCurveFitter extends AbstractCurveFitter {
    ...
    /** Initial guess. */
    private final double[] initialGuess_;
    ...
    public GaussianCurveFitter withStartPoint(double[] newStart) {
        return new GaussianCurveFitter(newStart.clone(), maxIter_);
    }
    ...
    public GaussianCurveFitter withMaxIterations(int newMaxIter) {
        return new GaussianCurveFitter(initialGuess_, newMaxIter);
    }
    ...
    protected LeastSquaresProblem getProblem(Collection<WeightedObservedPoint> observations) {
        ...
        final double[] startPoint = initialGuess_ != null ?
                initialGuess_ :
                new ParameterGuesser(observations).guess(); // compute estimation.

        // Return a new least squares problem set up to fit a Gaussian curve to the observed points.
    ...
    public static class ParameterGuesser {
        ...
        private List<WeightedObservedPoint> sortObservations(Collection<WeightedObservedPoint> unsorted) {
            ...
            final Comparator<WeightedObservedPoint> cmp = (p1, p2) -> {
                if (p1 == null && p2 == null) {
                    return 0;
                }
                if (p1 == null) {
         ...
         * @param startIdx Index within points from which to start the search for interpolation bounds points.
         * @param idxStep Index step for searching interpolation bounds points.
         * @param y Y value for which X should be determined.
         * @return the value of X for the specified Y.
         * @throws ZeroException if {@code idxStep} is 0.
         * @throws OutOfRangeException if specified {@code y} is not within the range of the specified {@code points}.
         */
        private double interpolateXAtY(
                WeightedObservedPoint[] points, int startIdx, int idxStep, double y) throws OutOfRangeException {
            if (idxStep == 0) {
         ...
         *
         * @param points Points to use for interpolation.
         * @param startIdx Index within points from which to start search for interpolation bounds points.
